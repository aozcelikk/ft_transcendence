# Generated by Django 5.0 on 2023-12-26 16:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('diger_users', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='kisi_engel', to=settings.AUTH_USER_MODEL)),
                ('users', models.ManyToManyField(to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
